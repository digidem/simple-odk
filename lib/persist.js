...
module.exports = function(data, filename, headers, user, callback) {
...
function persistS3(data, filename, headers, user, callback) {
...
function persistGithub(data, filename, headers, user, callback) {
